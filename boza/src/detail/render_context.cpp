...
namespace boza::detail
{
    ...
    {
        return instance().swapchain_;
    }

    void* RenderContext::resource_cache()
    {
        return instance().resource_cache_;
    }

    void* RenderContext::descriptor_pool()
    {
        return instance().descriptor_pool_;
    }

    void* RenderContext::current_command_buffer()
    {
        return instance().command_buffer_;
    }

    int RenderContext::api()
    {
        return instance().api_;
    }

    bool RenderContext::initialized()
    {
