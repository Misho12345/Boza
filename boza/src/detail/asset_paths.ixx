...
export namespace boza::detail
{
    ...
    public:
        ...
        static fs::path resolve_asset(const std::string& relative_path) { return assets_dir() / relative_path; }
        static fs::path resolve_texture(const std::string& texture_name) { return textures_dir() / texture_name; }
        static fs::path resolve_shader(const std::string& shader_name) { return shaders_dir() / shader_name; }
